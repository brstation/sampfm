...
i.frameBorder=0,i.width="100%",i.height="170px",i.id="cstrFreePlayerFrame",i.scrolling="no",i.allowtransparency="true",i.setAttribute("src",s),i.setAttribute("allowtransparency","true"),document.getElementById("cstrFreePlayerDiv").appendChild(i)}};cstrBindEvent(window,"load",cstrLoadFreePlayer);
